...
class ChunkMesh : public TMeshComponent<Vertex2Vec3>
{
public:
    ChunkMesh() = delete;
            ...
            for (int y = 0; y < CHUNK_SIZE; y++)
            {
                for (int z = 0; z < CHUNK_SIZE; z++)
                {
                    ...
                    if (pxBlock.GetID() == 0)
                    {
                        ...
                        AddToVertexBuffer(Vertex2Vec3(glm::vec3{xGlobal + 0.5f, yGlobal + 0.5f, zGlobal + 0.5f}, glm::vec3(1.0f, 0.0f, 0.0f)));
                        AddToVertexBuffer(Vertex2Vec3(glm::vec3{xGlobal + 0.5f, yGlobal - 0.5f, zGlobal + 0.5f}, glm::vec3(1.0f, 0.0f, 0.0f)));
                        AddToVertexBuffer(Vertex2Vec3(glm::vec3{xGlobal + 0.5f, yGlobal - 0.5f, zGlobal - 0.5f}, glm::vec3(1.0f, 0.0f, 0.0f)));
                        AddToVertexBuffer(Vertex2Vec3(glm::vec3{xGlobal + 0.5f, yGlobal + 0.5f, zGlobal - 0.5f}, glm::vec3(1.0f, 0.0f, 0.0f)));
                        offset = offset + 4;
                    ...
                    {
                        indices.insert(indices.end(), {0 + offset, 1 + offset, 2 + offset, 2 + offset, 3 + offset, 0 + offset});
                        AddToVertexBuffer(Vertex2Vec3(glm::vec3{xGlobal + 0.5f, yGlobal + 0.5f, zGlobal - 0.5f}, glm::vec3(0.0f, 1.0f, 0.0f)));
                        AddToVertexBuffer(Vertex2Vec3(glm::vec3{xGlobal - 0.5f, yGlobal + 0.5f, zGlobal - 0.5f}, glm::vec3(0.0f, 1.0f, 0.0f)));
                        AddToVertexBuffer(Vertex2Vec3(glm::vec3{xGlobal - 0.5f, yGlobal + 0.5f, zGlobal + 0.5f}, glm::vec3(0.0f, 1.0f, 0.0f)));
                        AddToVertexBuffer(Vertex2Vec3(glm::vec3{xGlobal + 0.5f, yGlobal + 0.5f, zGlobal + 0.5f}, glm::vec3(0.0f, 1.0f, 0.0f)));
                        offset = offset + 4;
                    ...
                    {
                        indices.insert(indices.end(), {0 + offset, 1 + offset, 2 + offset, 2 + offset, 3 + offset, 0 + offset});
                        AddToVertexBuffer(Vertex2Vec3(glm::vec3{xGlobal - 0.5f, yGlobal - 0.5f, zGlobal + 0.5f}, glm::vec3(0.0f, 0.0f, 1.0f)));
                        AddToVertexBuffer(Vertex2Vec3(glm::vec3{xGlobal + 0.5f, yGlobal - 0.5f, zGlobal + 0.5f}, glm::vec3(0.0f, 0.0f, 1.0f)));
                        AddToVertexBuffer(Vertex2Vec3(glm::vec3{xGlobal + 0.5f, yGlobal + 0.5f, zGlobal + 0.5f}, glm::vec3(0.0f, 0.0f, 1.0f)));
                        AddToVertexBuffer(Vertex2Vec3(glm::vec3{xGlobal - 0.5f, yGlobal + 0.5f, zGlobal + 0.5f}, glm::vec3(0.0f, 0.0f, 1.0f)));
                        offset = offset + 4;
