...
public:
    ...
    SquareMesh(float brightness = 1.0f)
    {
        ...
        auto& vertices = VertexBuffer.GetVertices();
        vertices.reserve(4);
        vertices.emplace_back(Vertex({+0.5f, -0.5f, 0.0f}, {brightness, brightness, brightness}, {1.0f, 0.0f}));
        vertices.emplace_back(Vertex({+0.5f, +0.5f, 0.0f}, {brightness, brightness, brightness}, {1.0f, 1.0f}));
        vertices.emplace_back(Vertex({-0.5f, +0.5f, 0.0f}, {brightness, brightness, brightness}, {0.0f, 1.0f}));
        vertices.emplace_back(Vertex({-0.5f, -0.5f, 0.0f}, {brightness, brightness, brightness}, {0.0f, 0.0f}));
